    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-gray-500 uppercase">
              Creator
            </h4>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                <h4 className="font-epilogue font-semibold text-[14px] text-gray-500 break-all">
                  {state.owner}
                </h4>
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#FFE2E2] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#FFE2E2] rounded-[10px]">
                <h4 className="font-epilogue font-semibold text-[14px] text-gray-500 leading-[22px]">
